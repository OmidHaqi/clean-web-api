...
func GenerateOtp() string {
	cfg := config.GetConfig()
	//TODO: Fix deprecated random number generator
	rand.Seed(time.Now().UnixNano())
	min := int(math.Pow(10, float64(cfg.Otp.Digits-1)))   // 10^digit-1 100000
	max := int(math.Pow(10, float64(cfg.Otp.Digits)) - 1) // 999999 = 1000000 - 1 (10^digit) -1
